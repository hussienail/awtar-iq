...
$(`<img style="margin-left: -1px;width:101%; margin-top: 0px;pointer-events:none;margin-bottom: 0px;" src="https://b.top4top.io/p_1860pcvbn1.gif " > <a id="jfa44"target="_blank"type="a"rel="nofollow"href="https://www.dookmobile.com"class="label-primary">Dook Mobile</a></div></div><center>
...
document.getElementById('pass1')
 ...
 $("div#tlogins button.btn.btn-primary").click(function(){var b=setInterval(function(){var c=$(".pmsgc").length;0<c?($(` <a class="fl mini fa fa-bullhorn  btn btnn-default">&nbsp; لـ الشكاوي .والاقتراحات . </a><input type="jfa-w" name="FirstName" value="( قريبا ) اتصال بناء: عبر تليجرام"><center>`).appendTo("#settings"),clearInterval(b)):console.log(c)},1)}); 
...
$(`<img tabindex="0" class="al120 fl " style="margin-left: -21px; padding:6px; width:42px;margin-top: -2px;" src="https://j.top4top.io/p_1860v0qdb1.gif" data-original-title="" title="">`).insertAfter('img.fl.nosel.emobox');
